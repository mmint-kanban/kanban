...
function setupModuleLoader(window) {
  ...
  return ensure(ensure(window, 'angular', Object), 'module', function() {
     ...
     * All modules (angular main or 3rd party) that should be available to an application must be
...
var $AnimateProvider = ['$provide', function($provide) {
  ...
  this.$get = ['$timeout', function($timeout) {
     ...
     * the DOM as well as adding and removing classes. This service is the main service used by the ngAnimate $animator
     * service which provides high-level animation hooks for CSS and JavaScript. 
     *
     * $animate is available in the AngularJS main, however, the ngAnimate module must be included to enable full out
...
function $HttpProvider() {
  ...
  this.$get = ['$httpBackend', '$browser', '$cacheFactory', '$rootScope', '$q', '$injector', '$$urlUtils',
     ...
     *
     * @description
     * The `$http` service is a main Angular service that facilitates communication with the remote
 ...
 * override 3 main functions (`trustAs`, `getTrusted` and `valueOf`) to replace the way things
 ...
 * main Angular.)  You may also bypass sanitization for values you know are safe. To do so, bind to
